    ...
    <Combobox value={selected} onChange={setSelected}>
      <div className="relative mt-1 ">
        <div className="relative w-full cursor-default overflow-hidden rounded bg-white text-left  ">
          <Combobox.Input
            className="w-full rounded border border-gray-400 px-2 py-3 pr-10 text-sm leading-5 text-gray-900 focus:outline-branding-pumpkin focus:outline-1 focus:border-none"
